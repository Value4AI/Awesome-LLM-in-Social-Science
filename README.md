...
Below we compile *awesome* papers that employ Large Language Models (LLMs) to create simulation environments, facilitating research in diverse fields including Social Science, Economics, and Policy-making.
